 ...
 * 
 * Modified in class on 4/4/2022 to have a repaint thread.
 * 
 * @author Jim Teresco
 * @version Spring 2022
 */
...
public class SnowScene extends MouseAdapter implements Runnable {
	...
	public void run() {
		...
		// active to call panel.repaint() about 30 times per second, so individual
		// FallingSnow objects do not need to do so.
		new Thread() {
			@Override
			public void run() {
				while (true) {
